...
use the \docenv{figure} or \docenv{margintable} environments as follows
...
The \docenv{figure} and \docenv{margintable} environments accept an optional parameter \docopt{offset} that adjusts the vertical position of the figure or table.  See the ``\nameref{sec:sidenotes}'' section above for examples.  The specifications are:
\begin{docspec}
  \doccmd{begin\{figure\}[\docopt{offset}]}\\
  \qquad\ldots\\
  \doccmd{end\{figure\}}\\
  \mbox{}\\
